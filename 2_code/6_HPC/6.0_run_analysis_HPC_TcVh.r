...
save(lr_model, dt_model, rf_model, nb_model, svm_model, knn_model, file = 
     paste('3_final/data/5_analysis/T', thinning, '_V', var_size, '/models.RData', sep = ''))
...
save.image(file =  paste('3_final/data/5_analysis/T', thinning, '_V', var_size, '/metrics.RData', sep = ''))
