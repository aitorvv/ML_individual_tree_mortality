...
#### Control and above model: model selection ####

# already selected models
models_list <- readRDS('/home/aitorvazquez/PhD/Vitality/3_final/data/7_applications/controlabove_models.rds')
my_models <- readRDS('/home/aitorvazquez/PhD/Vitality/3_final/data/7_applications/controlabove_models_summary.rds')

# read combis 
my_combis <- readRDS('/home/aitorvazquez/PhD/Vitality/3_final/data/4_datasets/combis_hard.RDS')

print('Loaded information for control + above models.')


#### Control and above model: from above data selection ####
...
model_used <- 'Tcontrolabove_Vhard'
...
#### Control and above model: from above predictions ####
...
#### Control and above model: from below data selection ####
...
#### Control and above model: from below predictions ####
...
#### Control and above model: control data selection ####
...
#### Control and above model: control predictions ####
...
# save metrics
save.image('/home/aitorvazquez/PhD/Vitality/3_final/data/7_applications/case_metrics_controlabove.RData')
...
print('Loaded information for control + below models.')


#### Control and below model: model selection ####

# already selected models
models_list <- readRDS('/home/aitorvazquez/PhD/Vitality/3_final/data/7_applications/controlbelow_models.rds')
my_models <- readRDS('/home/aitorvazquez/PhD/Vitality/3_final/data/7_applications/controlbelow_models_summary.rds')

# read combis 
my_combis <- readRDS('/home/aitorvazquez/PhD/Vitality/3_final/data/4_datasets/combis_hard.RDS')


#### Control and below model: control data selection ####
...
# set values of the case study
model_used <- 'Tcontrolbelow_Vhard'
data_used <- 'control_Vhard'
...
#### Control and below model: control predictions ####
...
#### Control and below model: from below data selection ####
...
#### Control and below model: from below predictions ####
...
#### Control and below model: from above data selection ####
...
#### Control and below model: from above predictions ####
...
# save metrics
save.image('/home/aitorvazquez/PhD/Vitality/3_final/data/7_applications/case_metrics_controlbelow.RData')
...
#### Above and below model: model selection ####

# already selected models
models_list <- readRDS('/home/aitorvazquez/PhD/Vitality/3_final/data/7_applications/abovebelow_models.rds')
my_models <- readRDS('/home/aitorvazquez/PhD/Vitality/3_final/data/7_applications/abovebelow_models_summary.rds')

# read combis 
my_combis <- readRDS('/home/aitorvazquez/PhD/Vitality/3_final/data/4_datasets/combis_hard.RDS')

print('Loaded information for above + below models.')


#### Above and below model: control data selection ####
...
#### Above and below model: control predictions ####
...
#### Above and below model: from above data selection ####
...
#### Above and below model: from above predictions ####
...
#### Above and below model: from below data selection ####
...
#### Above and below model: from below predictions ####
...
# save metrics
save.image('/home/aitorvazquez/PhD/Vitality/3_final/data/7_applications/case_metrics_abovebelow.RData')
