...
#------------------------------------------------------------------------------------------#
####                          Binary classification - df union                                
#                                                                                          #
#                            Aitor Vázquez Veloso, 09/01/2024                              #
...
# save.image(file =  paste('3_final/data/5_analysis/L', df_len, '_V', var_size, '/tmp_metrics.RData', sep = ''))
# 
# 
# #### Perform DT analysis ####
# 
...
load(paste('3_final/data/5_analysis/L', df_len, '_V', var_size, '/tmp_metrics.RData', sep = ''))
load(paste('3_final/data/5_analysis/L', df_len, '_V', var_size, '/tmp_metrics_b.RData', sep = ''))
