...
load('/home/aitorvazquez/PhD/Vitality/3_final/data/6_final_results/case_study_summary.RData')

# load functions to graph
source('3_final/scripts/8.1_functions_performance_graphs.r')
...
for(case in 1:length(case_study$name)){
  ...
  load(paste('3_final/data/6_final_results/', case_study$name[case], '/final_metrics.RData', sep = ''))
...
save.image('3_final/data/6_final_results/best_models.RData')
