...
print('Loaded information for control models.')
...
# save metrics
save.image('/home/aitorvazquez/PhD/Vitality/3_final/data/7_applications/case_metrics_control.RData')
...
print('Loaded information for above models.')
...
# already selected models
models_list <- readRDS('/home/aitorvazquez/PhD/Vitality/3_final/data/7_applications/above_models.rds')
my_models <- readRDS('/home/aitorvazquez/PhD/Vitality/3_final/data/7_applications/above_models_summary.rds')
...
# save metrics
save.image('/home/aitorvazquez/PhD/Vitality/3_final/data/7_applications/case_metrics_above.RData')
...
# already selected models
models_list <- readRDS('/home/aitorvazquez/PhD/Vitality/3_final/data/7_applications/below_models.rds')
my_models <- readRDS('/home/aitorvazquez/PhD/Vitality/3_final/data/7_applications/below_models_summary.rds')

# read combis 
my_combis <- readRDS('/home/aitorvazquez/PhD/Vitality/3_final/data/4_datasets/combis_hard.RDS')

print('Loaded information for below models.')
...
# save metrics
save.image('/home/aitorvazquez/PhD/Vitality/3_final/data/7_applications/case_metrics_below.RData')
