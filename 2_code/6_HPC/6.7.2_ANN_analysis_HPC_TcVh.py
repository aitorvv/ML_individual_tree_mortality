...
🔑 **Note**: to use a different radii you have to change all the paths, the rest is fine
...
path_train = '/home/aitorvazquez/PhD/Vitality/3_final/data/5_analysis/ann/input/T{}_V{}/train/'.format(thinning, var_size)
path_test = '/home/aitorvazquez/PhD/Vitality/3_final/data/5_analysis/ann/input/T{}_V{}/test/'.format(thinning, var_size)
...
for combi in range(len(train_files)):
  ...
  output_path = '/home/aitorvazquez/PhD/Vitality/3_final/data/5_analysis/ann/preds/T', thinning, '_V', var_size, '/', model_index, '.json'
  output_path = ''.join(output_path)
  json.dump(preds, open(output_path, 'w'))

  # save the output - history
  output_path = '/home/aitorvazquez/PhD/Vitality/3_final/data/5_analysis/ann/history/T', thinning, '_V', var_size, '/', model_index, '.npy'
  output_path = ''.join(output_path)
...
output_path = '/home/aitorvazquez/PhD/Vitality/3_final/data/5_analysis/ann/timer/T{}_V{}/ann_time_list.json'.format(thinning, var_size)
