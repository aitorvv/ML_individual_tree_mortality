...
df_len = '6to7'  # 3to5, 5to6, 6to7, 7to9
...
for (k in my_combis){
  ...
  # export data
  write.csv(train, paste('3_final/data/5_analysis/ann/input/L', df_len, '_V', var_size, '/train/', name, '.csv', sep = ''), row.names = FALSE)
  write.csv(test, paste('3_final/data/5_analysis/ann/input/L', df_len, '_V', var_size, '/test/', name, '.csv', sep = ''), row.names = FALSE)
}
...
# save my_timer
write.csv(my_timer, paste('3_final/data/5_analysis/ann/timer/L', df_len, '_V', var_size, '/ANN_1_timer.csv', sep = ''), row.names = FALSE)
