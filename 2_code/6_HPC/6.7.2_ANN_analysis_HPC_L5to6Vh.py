...
path_train = '/home/aitorvazquez/PhD/Vitality/3_final/data/5_analysis/ann/input/L{}_V{}/train/'.format(df_len, var_size)
path_test = '/home/aitorvazquez/PhD/Vitality/3_final/data/5_analysis/ann/input/L{}_V{}/test/'.format(df_len, var_size)
...
for combi in range(len(train_files)):
  ...
  output_path = '/home/aitorvazquez/PhD/Vitality/3_final/data/5_analysis/ann/preds/L', df_len, '_V', var_size, '/', model_index, '.json'
  output_path = ''.join(output_path)
  json.dump(preds, open(output_path, 'w'))

  # save the output - history
  output_path = '/home/aitorvazquez/PhD/Vitality/3_final/data/5_analysis/ann/history/L', df_len, '_V', var_size, '/', model_index, '.npy'
  output_path = ''.join(output_path)
...
output_path = '/home/aitorvazquez/PhD/Vitality/3_final/data/5_analysis/ann/timer/L{}_V{}/ann_time_list.json'.format(df_len, var_size)
