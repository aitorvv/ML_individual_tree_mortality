...
load('1_data/1_processed/6_final_results/case_study_summary-training_2_thinning.RData')
...
save.image('1_data/1_processed/6_final_results/best_models-training_2_thinning.RData')
